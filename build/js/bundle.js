  ...
  loadMoreCards: function(cb) {
    window.setTimeout(function() {
      ...
      newCards = newCards.concat([
        React.createElement(Card, null), React.createElement(Card, null), React.createElement(Card, null), React.createElement(Card, null)
      ]);
  ...
  var Card = React.createClass({displayName: "Card",
    ...
    render: function() {
      return React.createElement("div", {
                ...
                style: this.style, 
                className: "card"}, this.props.children);
    },
      ...
      return React.createElement(Card, null, 
        ...
        React.createElement("div", {style: this.style.content}, 
          React.createElement("div", {style: this.style.contentInner}, 
            React.createElement("h1", {style: this.style.h1}, "Arthur Lee"), 
            React.createElement("h2", {style: this.style.h2}, "Designer & Developer"), 
            React.createElement("div", {style: this.style.socialLinks}, 
              React.createElement(SocialBtn, {href: "http://www.google.com/recaptcha/mailhide/d?k=01OWkW9eUwqxP23Bxfd4o8pw==&c=FVysm5b2s6wu3dgCw4p4R4PNpxPDYSSb9SWUs-ltErQ=", icon: "fa-envelope-o"}), 
              React.createElement(SocialBtn, {href: "http://www.linkedin.com/in/arthuralee", icon: "fa-linkedin"}), 
              React.createElement(SocialBtn, {href: "https://github.com/arthuralee", icon: "fa-github"})
            )
          )
        )
      )
...
module.exports = (function() {
  var ImageView = React.createClass({displayName: "ImageView",
    ...
    render: function() {
      ...
      return React.createElement("div", {style: this.style, ref: "image"});
    },
    style: {
...
module.exports = (function() {
    ...
    var ScrollLoader = React.createClass({displayName: "ScrollLoader",
      ...
      render: function() {
        ...
        return React.createElement("div", {style: divStyle}, React.createElement("i", {style: this.style.loader, className: 'fa fa-2x fa-circle-o-notch fa-spin'}));
      },
...
module.exports = (function() {
  var SocialBtn = React.createClass({displayName: "SocialBtn",
    getInitialState: function() {
      return {
        mouseIn: false
      }
    ...
    render: function() {
      ...
      return React.createElement("a", {href: this.props.href, onMouseOver: this.mouseOver, onMouseOut: this.mouseOut, target: "_blank"}, 
        React.createElement("span", {style: linkStyle}, 
          React.createElement("i", {style: this.style.span, className: ("fa " + this.props.icon)})
        )
      );
    },
    mouseOver: function() {
